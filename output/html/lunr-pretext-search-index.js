...
},
{
  ...
  "type": "Example",
  "number": "4.3.3",
  "title": "A Wedding Photo, Part II.",
  "body": "A Wedding Photo, Part II  Assume that we want a photo where the bride and groom are positioned in the center of the photo, with the groom to the left of the bride, the groom's family to the left of the groom, and the bride's family to the right of the bride. How many different arrangements of the individuals for the photo satisfy these requirements?  This photograph is more restrictive than the previous one. Because of this we should expect that there are fewer arrangements resulting in an acceptable photo. Since the groom's family should be to the left of the groom and the bride's family to the right of the bride, we know that the groom must occupy the position fourth from the left and the bride must occupy the position fifth from the left. Let's start with such an arrangement. We'll let G stand for the groom and B stand for the bride.   Notice that there is no choice in the placement we just made. There is exactly one way to have the groom occupy the fourth position from the left and the bride occupy the fifth position. We do have some choice in how to fill in the remaining positions though.   Now, since there are three remaining members of the groom's family, we have three options for who will occupy the leftmost position, two who will occupy the next position and then the final member of the groom's family will fill in the position just to the left of the groom.   Similarly, we can fill in the positions to the right of the bride. We need only remember that there are four additional members of her family.   Recalling that there was no choice in how the bride and groom were positioned, we use the Fundamental Principle of Counting to compute the total number of arrangements for the photo.   Adding those additional restrictions drastically reduced the number of acceptable arrangements for the photo. We went from arrangements for the unrestriced photo to only arrangements for the photo with these restrictions!   "
},
{
  ...
  "type": "Example",
  "number": "4.3.4",
  "title": "A Wedding Photo, Part III.",
  "body": "A Wedding Photo, Part III  The wedding photographer has set up a photo booth which can accommodate six people at a time. In how many ways can six members of the wedding party arrange themselves (left to right) for a photo in the photo booth?  While there aren't positional restrictions on this photo, there is a size restriction. Not all of the nine family members will be able to be in the picture. That being said, the approach is still the same. We have six positions to fill.   We'll fill each of the positions above. All nine of the family members are available to fill the leftmost position.   Once the family member has been chosen to take the leftmost position, there are eight faily members available for the next, and so on until all of the positions have been filled.   Notice that all of the positions for the photo have been filled. The remaining three family members will not be in the photo, so their positional order does not matter. The total number of arrangements for a family photo in the photo booth are   That is, there are 60,480 different arrangements for the photo booth photo which will include six of the nine family members.   "
},
{
...
{
  "id": "sec_counting-permutations-4-3",
  "level": "2",
  "url": "sec_counting-permutations.html#sec_counting-permutations-4-3",
  "type": "Checkpoint",
  "number": "4.3.6",
  "title": "Creating \"Words\" from an Alphabet.",
  "body": "Creating \"Words\" from an Alphabet "
...
{
  "id": "sec_counting-permutations-4-4",
  "level": "2",
  "url": "sec_counting-permutations.html#sec_counting-permutations-4-4",
  "type": "Checkpoint",
  "number": "4.3.7",
  "title": "Choosing Club Leadership.",
  "body": "Choosing Club Leadership "
},
{
  "id": "sec_counting-permutations-4-5",
  "level": "2",
  "url": "sec_counting-permutations.html#sec_counting-permutations-4-5",
  "type": "Checkpoint",
  "number": "4.3.8",
  "title": "Choosing a Restrictive Password.",
  "body": "Choosing a Restrictive Password "
},
{
  "id": "sec_counting-permutations-4-6",
  "level": "2",
  "url": "sec_counting-permutations.html#sec_counting-permutations-4-6",
  "type": "Checkpoint",
  "number": "4.3.9",
  "title": "Building a Relay Team.",
...
{
  "id": "sec_probability-basics-4-6",
  "level": "2",
  "url": "sec_probability-basics.html#sec_probability-basics-4-6",
  "type": "Example",
  "number": "6.1.7",
  "title": "Drawing the Four of Clubs <em class=\"emphasis\">and<\/em> a Red Card.",
  "body": "Drawing the Four of Clubs and a Red Card   Consider a scenario in which we are drawing a single card from a well-shuffled standard deck of 52 cards. What is the probability of drawing the four of clubs and that card is a red card?    Since the four of clubs is a black card, there are ways in which we can observe an outcome where the card we draw is both the four of clubs and is a red card (the event ). Using the our definiton of the probability of an event, we have:    "
},
{
  "id": "sec_probability-basics-4-8",
  "level": "2",
  "url": "sec_probability-basics.html#sec_probability-basics-4-8",
  "type": "Example",
  "number": "6.1.8",
  "title": "Drawing a Red, Face Card.",
  "body": "Drawing a Red, Face Card   Consider a scenario in which we are drawing a single card from a well-shuffled standard deck of 52 cards. What is the probability of drawing a red, face-card from the deck?    Note that our event , of drawing a red, face-card could be restated as \"the event that we draw a red card and that card is also a face card\". Recall that face-cards in a deck are the Jacks, Queens, and Kings. This means that there are total face cards in the deck. We also know from an earlier example that there are red cards in the deck. However, only six of the face cards are red. This means that there are ways in which we can observe our event as the outcome of drawing a single card from a 52-card deck.  Using our definition of probability, we can compute:    "
},
{
  "id": "sec_probability-basics-4-9",
  "level": "2",
  "url": "sec_probability-basics.html#sec_probability-basics-4-9",
  "type": "Example",
  "number": "6.1.9",
  "title": "Drawing a Red Card or a Face Card.",
  "body": "Drawing a Red Card or a Face Card   Consider the same scenario in which we are drawing a single card from a well-shuffled standard deck of 52 cards. What is the probability of drawing a red card or a face-card from the deck?    As in the previous example, the face-cards in a deck are the Jacks, Queens, and Kings. This means that there are total face cards in the deck. Similarly, we know that there are red cards in the deck.  The problem we encounter here is that some of those face cards are also red cards. If we were to just add the face cards to the red cards, we would be double-counting all of the red, face-cards. To remove this double counting, we'll subtract out the number of red, face-cards. That is,   Now we can use our definition to compute the probability:    "
},
{
  "id": "sec_probability-basics-4-12",
  "level": "2",
  "url": "sec_probability-basics.html#sec_probability-basics-4-12",
  "type": "Definition",
  "number": "6.1.10",
  "title": "Principle of Inclusion and Exclusion (PIE).",
  "body": "Principle of Inclusion and Exclusion (PIE)   The Principal of Inclusion and Exclusion is a counting technique which can be utilized to count the number of items in a union of sets, whether those sets are disjoint (non-overlapping) or not. This counting method extends to the union between any number sets. We'll show the two- and three-set forms below:    "
},
{
  "id": "sec_probability-pendance",
  "level": "1",
  "url": "sec_probability-pendance.html",
  "type": "Section",
  "number": "6.2",
  "title": "Consecutive Events: Independence or Dependence",
  "body": " Consecutive Events: Independence or Dependence   In the previous section, we were interested in a single outcome associated with a single (atomic) process. We learned and practiced how to compute probabilities associated with outcomes\/events that were determined by multiple restrictions (drawing a red card and a face card) as well as outcomes that were described by \"options\" (drawing a red card or a face card).  In this section we'll be interested in outcomes associated with distinct processes. For example, perhaps we roll a die and then draw a card from a deck. Similarly, perhaps we deal two cards from a deck rather than a single card. In this latter example, we can consider the drawing of each individual card as an atomic process). In the first example, the outcome of the die roll doesn't impact the drawing of a card -- these events are independent . In the second example, however, the result of the first card dealt does impact the probabilities associated with what our second card will be -- the dealing of these two cards are dependent events.  Let's dig into the section to learn more and gain some practice.   Consecutive Events, Independence\/Dependence, and Probabilities  Sometimes we are interested in the probabilities of outcomes associated with several distinct processes. For example, we may want to know the probability of being dealt an two Aces    In this section you learned, and practiced with...   "
},
{
